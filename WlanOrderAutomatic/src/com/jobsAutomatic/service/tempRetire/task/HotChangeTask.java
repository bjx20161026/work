...
import com.jobsAutomatic.service.check.QueueCheckPut;
...
public class HotChangeTask extends ATask {
	...
	public void HandleTask() {
		try {
			...
			jdbcTemplate.update("update work_order set  statement='处理中',include = ? where workjob_id = ?", include,
			...
			new QueueCheckPut(include,workOrder.getWorkjob_id());
		} catch (Exception e) {
